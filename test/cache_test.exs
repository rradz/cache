defmodule CacheTest do
  ...
  describe "registration" do
    test "correctly registers the function" do
      assert :ok = Cache.register_function(&DummyFunctions.success/0, "success", 1_000, 10_000)
      assert :ok = Cache.register_function(&DummyFunctions.success/0, "success_2", 1_000, 10_000)
      assert :ok = Cache.register_function(&DummyFunctions.failure/0, "failure", 1_000, 10_000)
    end
    ...
    test "doesn't allow registering under the same key twice" do
      ...
      assert {:error, :already_registered} =
               Cache.register_function(&DummyFunctions.success/0, "success", 1_000, 10_000)
    end
  end

  describe "retrieval" do
    setup do
      :ok = Cache.register_function(&DummyFunctions.success/0, "success", 1_000, 10_000)
      ...
      :ok = Cache.register_function(&DummyFunctions.failure/0, "failure", 1_000, 10_000)
    end
